...
import { GraduationCap, BookOpen, Clock, Star, Users, Search, Filter } from "lucide-react"
  ...
  const courses = [
    {
      ...
      description: "Pelajari front-end dan back-end development dari dasar hingga mahir",
    ...
    },
    {
      ...
      description: "Kuasai analisis data dan machine learning dengan Python",
    ...
    },
    {
      ...
      description: "Belajar desain interface dan user experience yang menarik",
      category: "Design",
      level: "Pemula",
      duration: "25 jam",
      students: 1450,
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-b from-primary/5 to-transparent py-12 border-b">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl font-bold mb-4">Jelajahi Kursus</h1>
            <p className="text-lg text-muted-foreground mb-6">
              Temukan berbagai kursus berkualitas untuk mengembangkan skill dan mempersiapkan karirmu
            </p>
            <div className="flex gap-3">
              <div className="flex-1 relative">
                <Search className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                <Input placeholder="Cari kursus..." className="pl-9" />
              </div>
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="text-sm text-muted-foreground">Menampilkan {courses.length} kursus</div>
        </div>
